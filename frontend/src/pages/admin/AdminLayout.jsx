    ...
    <div className="min-h-screen" style={{ background: '#f0f2f5' }}>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '64px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                <div style={{ fontWeight: '800', fontSize: '18px', color: 'white', letterSpacing: '-0.5px' }}>HODY Admin</div>
                <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.5)', marginTop: '-2px' }}>Quản trị hệ thống</div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <div style={{ display: 'none' }} className="admin-user-info">
                  ...
                  <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.5)' }}>Administrator</div>
                </div>
              </div>
              ...
              <button
                ...
                onMouseEnter={e => {
                  e.currentTarget.style.background = 'rgba(227,24,55,0.3)'
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '24px', display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
        ...
        <aside style={{
            ...
            {navItems.map((item) => (
              <NavLink
                ...
                style={({ isActive }) => ({
                  ...
                  textDecoration: 'none',
                  transition: 'all 0.2s',
                  boxShadow: isActive ? '0 4px 12px rgba(227,24,55,0.3)' : 'none',
                })}
                onMouseEnter={(e) => {
          ...
          <div style={{ marginTop: '24px', padding: '16px', background: 'linear-gradient(135deg, #1a1a2e, #0f3460)', borderRadius: '12px', color: 'white' }}>
            <div style={{ fontSize: '12px', fontWeight: '600', marginBottom: '4px', opacity: 0.9 }}>Xin chào 👋</div>
            <div style={{ fontSize: '14px', fontWeight: '700' }}>{user?.name || 'Admin'}</div>
            <div style={{ fontSize: '11px', opacity: 0.6, marginTop: '2px' }}>{user?.email}</div>
          </div>
        </aside>
